      ...
      <div class="flex flex-col md:flex-row">
        <div class="w-full md:w-1/3 mx-1">
          <table class="table-auto w-full">
            <tr>
              <td>項目</td>
              <td>{{ construction.Item }}</td>
            </tr>
            <tr>
              <td>類別</td>
              <td>{{ construction.Category }} - {{ construction.Id }}</td>
            </tr>
            <tr>
              <td>完工</td>
              <td>{{ construction.Due }}</td>
            </tr>
            <tr>
              <td>經費</td>
              <td>
            ...
            <tr>
              <td>狀態</td>
              <td>{{ construction.StatusB }} - {{ construction.StatusA }}</td>
            </tr>
          </table>
          <h2>計畫概要</h2>
          <p v-html="construction.DescriptionA"></p>
