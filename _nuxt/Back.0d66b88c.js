...
</p>`,Date:"7/17/23",Link:"https://www.facebook.com/profile.php?id=100064026103094"}],c={},s={class:"container mb-4 mr-8 flex justify-end"},p=a("button",{class:"btn btn-primary"},"回列表清單",-1);function m(u,_){const t=n;return e(),o("div",s,[i(t,{to:"/community"},{default:l(()=>[p]),_:1})])}const C=r(c,[["render",m]]);export{C as _,y as a};
