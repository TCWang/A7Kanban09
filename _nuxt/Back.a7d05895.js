...
</p>`,Date:"2023/11 - 2024/01",Link:"https://www.facebook.com/profile.php?id=100069676248826"},{No:"長庚里-001",Community:"長庚里",Title:"社區照顧 C據點活動",Category:"林俊源",Category1:"3.社團活動與急難救濟",Category2:"3.1 舉辦社團活動",Subtitle:"社區關懷中心 定期活動通告",Description:`<p>長庚里里長  已開辦  社區照顧 C據點活動 巷弄長照站\r
<ul>\r
...
</p>`,Date:"7/17/23",Link:"https://www.facebook.com/profile.php?id=100064026103094"}],c={},s={class:"container mb-4 mr-8 flex justify-end"},p=a("button",{class:"btn btn-primary"},"回列表清單",-1);function m(_,u){const t=n;return r(),o("div",s,[e(t,{to:"/community"},{default:l(()=>[p]),_:1})])}const f=i(c,[["render",m]]);export{f as _,C as a};
